        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatestIndexInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VoltageDuringMeasurement = table.Column<double>(type: "float", nullable: false),
                    CurrentDuringMeasurement = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 17, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "OperationClaims.Create", null },
                    ...
                    { 20, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Counters.Admin", null },
                    { 21, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Counters.Read", null },
                    { 22, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Counters.Write", null },
                    { 23, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Counters.Create", null },
                    { 24, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Counters.Update", null },
                    { 25, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Counters.Delete", null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@nArchitecture.kodlama.io", new byte[] { 219, 94, 125, 186, 255, 197, 158, 240, 28, 39, 126, 165, 35, 174, 206, 213, 225, 253, 188, 136, 119, 177, 183, 178, 218, 72, 87, 142, 182, 64, 249, 244, 80, 100, 34, 68, 84, 235, 214, 16, 187, 134, 102, 169, 196, 7, 100, 100, 96, 6, 103, 152, 40, 19, 242, 227, 48, 62, 247, 249, 176, 5, 7, 151 }, new byte[] { 25, 225, 201, 29, 82, 68, 5, 17, 190, 110, 63, 133, 195, 186, 103, 77, 19, 112, 81, 229, 86, 241, 49, 188, 247, 11, 207, 153, 71, 140, 158, 229, 23, 24, 14, 73, 249, 157, 177, 98, 76, 222, 74, 147, 247, 113, 94, 88, 47, 9, 17, 185, 84, 190, 5, 133, 18, 233, 151, 33, 179, 133, 225, 141, 169, 107, 77, 20, 170, 246, 125, 157, 20, 218, 254, 238, 48, 143, 48, 84, 193, 234, 94, 95, 29, 179, 37, 230, 149, 227, 214, 38, 47, 9, 24, 213, 23, 102, 63, 217, 13, 239, 65, 254, 241, 112, 39, 100, 132, 246, 19, 14, 4, 219, 56, 132, 28, 29, 99, 219, 164, 250, 15, 30, 36, 149, 80, 94 }, null });
